...
permalink: /resources/18F/derisking-gov-tech/state-software-budgeting-handbook/basic-principles/
toc: true
categories:
  - Resources
  - 18F
...
@WARNING This content was originally created by 18F at GSA and is public domain.
{:.notes}

## Basic principles of modern software&nbsp;design

![](/resources/18F/derisking-gov-tech/assets/agile-basics.svg){:.chapter__img}
...
Earlier this year the U.S. Department of Defense’s Defense Innovation Board released its Software Acquisition and Practices (SWAP) Study including a concept paper on "[Detecting Agile BS](/resources/18F/derisking-gov-tech/assets/DIBGUIDEDETECTINGAGILEBS.PDF)," which provides a useful synopsis of agile practices, and a series of questions to help non-technical leaders understand whether those practices are being followed.
...
By combining user-centered design, agile, product ownership, DevOps, and building with loosely coupled parts, it’s possible to break up a large, risky contract into a handful of smaller contracts. A contract should be small enough that the agency will have no compunction about giving no further work to a non-performing vendor, replacing them with a new vendor. (See "[Procure services, not software]({{site.baseurl}}/state-software-budgeting-handbook/#procure-services-not-software)" for how this is done.) The rest of the vendors will continue working, so the total loss of velocity will be minimal. A new vendor should have no difficulty taking over for the old one, since the old one was delivering completed, documented, tested software every two weeks. Another benefit is that small contracts may come in under your state’s simplified procurement threshold, meaning that agencies can write a request for proposals, publish it, and award a contract, all within 90 days or so.
...
**Next**: [Budgeting and overseeing tech projects](/resources/18F/derisking-gov-tech/state-software-budgeting-handbook/budgeting-tech/)
