...
permalink: /resources/18F/derisking-gov-tech/qasp/
categories:
  - Resources
  - 18F
  - Derisking Gov Tech
...
![](/resources/18F/derisking-gov-tech/assets/qasp-checks.svg){:.chapter__img}

Per [the "Require demos, not memos" best practice]({{ site.baseurl }}/state-software-budgeting-handbook/#require-demos-not-memos), here is a sample QASP, which should be incorporated into agile software RFPs.
