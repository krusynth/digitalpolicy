...
permalink: /resources/18F/derisking-gov-tech/federal-field-guide/doing-the-work/
toc: true
categories:
  - Resources
  - 18F
...
![](/resources/18F/derisking-gov-tech/assets/fed4-work.svg){:.chapter__img}
...
Specifically, we expect the code and documentation to be tested, properly styled, secure, documented, deployed, and based on user research. Teams can use [the QASP that 18F uses on agile development contracts](/resources/18F/derisking-gov-tech/qasp/) and incorporate it as-is.
...
**Next**: [Appendix](/resources/18F/derisking-gov-tech/federal-field-guide/appendix/)
